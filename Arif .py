...
▐▌ ▐▌▐▌ ▐▌▗▄█▄▖▐▌
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Arif lslam
\033[1;37m Facebook:            Arif lslam
\033[1;37m Github  :            Arif-Ssb
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/Ariflslam.6')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +Arif)
    os.system('sort -r '+ssb+' | uniq > '+Arif)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + Arif )
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Arif  ")
    SSB(allkey)       
